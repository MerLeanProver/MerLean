...
- **Numerical experiments** — resolve `<PLUGIN_ROOT>` from this `SKILL.md` location, write scripts
  in your scratch space, and run them with `<PLUGIN_ROOT>/.venv/bin/python` (numpy etc. from the
  shared venv). If you need a package the venv lacks,
